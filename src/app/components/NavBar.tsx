...
export default function NavBar() {
  return (
    <div id="navbar" className='hidden z-30 sm:block fixed border-r top-0 left-0 w-auto px-3 2xl:px-0 2xl:w-[296px] h-screen bg-white'>
      <div className='flex flex-col  w-full items-center mt-0 2xl:mt-10 py-2 h-full justify-between max-h-none 2xl:max-h-[700px]'>
        <nav className='w-auto 2xl:w-[233px] flex flex-col space-y-2.5'>
          <Link style={LinkStyles} href={"/"} className='relative nav-link'>
            <div className='absolute size-full flex justify-center items-center'>
              <div className='temp-bg'></div>
            </div>
            <div style={LinkContentStyle} className='nav-content'>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.79 22.75H6.21C3.47 22.75 1.25 20.52 1.25 17.78V10.37C1.25 9.00997 2.09 7.29997 3.17 6.45997L8.56 2.25997C10.18 0.999974 12.77 0.939974 14.45 2.11997L20.63 6.44997C21.82 7.27997 22.75 9.05997 22.75 10.51V17.79C22.75 20.52 20.53 22.75 17.79 22.75ZM9.48 3.43997L4.09 7.63997C3.38 8.19997 2.75 9.46997 2.75 10.37V17.78C2.75 19.69 4.3 21.25 6.21 21.25H17.79C19.7 21.25 21.25 19.7 21.25 17.79V10.51C21.25 9.54997 20.56 8.21997 19.77 7.67997L13.59 3.34997C12.45 2.54997 10.57 2.58997 9.48 3.43997Z" fill="#212121" />
                <path d="M12 18.75C11.59 18.75 11.25 18.41 11.25 18V15C11.25 14.59 11.59 14.25 12 14.25C12.41 14.25 12.75 14.59 12.75 15V18C12.75 18.41 12.41 18.75 12 18.75Z" fill="#212121" />
              </svg>
              <span className='hidden 2xl:block' style={LinkContentTextStyle}>Dashboard</span>
            </div>
          </Link>
          <Link style={LinkStyles} href={"/"} className='relative nav-link-selected'>
            <div className='absolute size-full flex justify-center items-center'>
              <div className='temp-bg'></div>
            </div>
            <div style={LinkContentStyle} className='nav-content'>
          ...
          <Link style={LinkStyles} href={"/"} className='relative nav-link'>
            ...
            <div style={LinkContentStyle} className='nav-content'>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="12.1751" cy="11.8886" r="2.63616" stroke="#53545C" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
