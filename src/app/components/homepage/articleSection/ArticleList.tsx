...
export default function ArticleList() {
  ...
  useEffect(() => {
    ...
    articleListRef.current?.addEventListener('scroll', onScrollEventListner)

    onScrollEventListner()
    windowResizeEventListner()
    return () => {
      window.removeEventListener('resize', windowResizeEventListner)
      articleListRef.current?.removeEventListener('scroll', onScrollEventListner)
    }
  }, [articleListRef, scrollByValue])
