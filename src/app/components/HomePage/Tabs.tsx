    ...
    <div className="pl-1.5 xs:pl-3 sm:mt-0 grid grid-cols-2 gap-0.5 xs:gap-2 md:gap-5 mr-2 md:mr-0 lg:gap-0 lg:flex justify-between max-w-[470px] sm:max-w-[650px] lg:max-w-[1250px] desktop:max-w-[1500px]">
      {
        tabsList.map(({ name, imgSrc, count }, index) => {
          return <div key={index} className="flex text-[#212121] border mr-2 space-x-1.5 xl:space-x-3 items-center  rounded-[20px] w-full md:w-[290px] lg:w-[250px] xl:w-[290px] h-16 xs:h-20 sm:h-28 pl-1 sm:pl-3 lg:pl-1.5 xl:pl-3 desktop:px-0 desktop:py-0 desktop:pl-5 desktop:h-36 desktop:w-[350px] bg-white">
