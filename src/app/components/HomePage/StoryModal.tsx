  ...
  if (storyImgSrc && storyHeading && storyUrl && storyIndex) {
    return (
      <div
        ...
        className='absolute top-0 left-0 z-20 w-full img-modal-height min-h-[700px]'>
        <div className=" bg-main-1 w-full h-full pb-5">
          <div className="px-2 xs:px-10 pt-2.5 pb-5 h-full">
