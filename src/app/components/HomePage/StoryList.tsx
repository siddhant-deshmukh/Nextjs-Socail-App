...
export default function StoryList() {
  ...
  useEffect(() => {
    if (storyRef.current) {
      ...
      storyRef.current.addEventListener('scroll', () => {
        if (storyRef.current) {
    ...
    <div className='relative'>
      ...
      <div ref={storyRef} className="overflow-x-auto scroll-smooth no-scrollbar">
        ...
        <button
          ...
          className='absolute z-20 top-1/2 p-2 bg-purple-700 bg-opacity-50 aspect-square rounded-full left-2.5 sm:left-10 ml-0'>
